...
def phenotrex_parsing():
    phenotrex_dir = '//wsl.localhost/Ubuntu/home/vitt\\validation_sets\\motility_validation\\phenotrex_outputs'
    ...
    for root, subfolders, files in os.walk(phenotrex_dir):
        for file in files:
            ...
            if fnmatch.fnmatch(file, '*motility.svm.class.csv*'):
                #print("FOUND:", file)
                try:
    ...
    print(phenotrex_SGB)
    phenotrex_SGB.to_csv('//wsl.localhost/Ubuntu/home/vitt/phenotrex_motility_validation.npy')

# -------------TRAITAR_PARSING-----------------------
def traitar_parsing():

    traiatar_dir = '//wsl.localhost/Ubuntu/home/vitt\\validation_sets\\motility_validation\\traitar_outputs'
    ...
    print(traitar)
    traitar.to_csv('//wsl.localhost/Ubuntu/home/vitt/traitar_motility_validation.npy')

# ------------------MAIN-----------------------------
def main():
    print("---------STARTING data parsing for MOTILITY------------")
